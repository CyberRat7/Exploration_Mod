...
public interface BowlFoodItemFactory extends DefaultItemFactory {
    static RegistryObject<BowlFoodItem> create(String name, int nutrition, float saturation) {
        return DefaultItemFactory.createTyped(name, () -> new BowlFoodItem(new Item.Properties().food(new FoodProperties.Builder().nutrition(nutrition).saturationMod(saturation).build())));
