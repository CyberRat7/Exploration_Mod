...
import net.explorationmod.cyber2000.core.registry.factory.item.BowlFoodItemFactory;
...
public class VentureItems {
    ...
    public static final RegistryObject<BowlFoodItem> NETTLE_SOUP = BowlFoodItemFactory.create("nettle_soup", 5, 4);
