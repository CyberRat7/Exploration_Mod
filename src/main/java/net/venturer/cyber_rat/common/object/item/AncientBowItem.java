package net.venturer.cyber_rat.common.object.item;
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!level.isClientSide) {
                        ArrowItem arrowItem = (AncientArrowItem) (itemstack.getItem() instanceof AncientArrowItem ? itemstack.getItem() : VenturerItems.ANCIENT_ARROW.get());
