package net.venturer.temporal.core.util;
...
public class VenturerPlacedFeatureUtils {
    public static ResourceKey<PlacedFeature> createKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Venturer.MOD_ID, name));
    }
